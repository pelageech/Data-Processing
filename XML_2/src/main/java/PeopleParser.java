...
public class PeopleParser {
    ...
    public HashMap<String, PersonInfo> parse(InputStream stream) throws XMLStreamException {
    ...
    private HashMap<String, PersonInfo> normalize(ArrayList<PersonInfo> data, Integer peopleCount) {
        ...
        // merge all people that hasn't tezzkis
        for (PersonInfo p : data) {
            ...
            if (found.size() == 1) {
                ...
                //System.out.println("ID:" + key + " NAME: " + foundPerson.getFullName() + " FOUND NAME:" + p.getFullName());
                foundPerson.merge(p);
    ...
    private void findInRecords(HashMap<String, PersonInfo> id_records, PersonInfo p, String s) {
